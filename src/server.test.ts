...
test("tool modes expose the expected host-facing tool surface", async (t) => {
  const cases: Array<{
    ...
    {
      mode: "claude",
      expected: ["open_workspace", "read", "agent_task", "write", "edit", "bash", "show_changes"],
    },
    {
      mode: "codex",
      expected: ["open_workspace", "read", "agent_task", "apply_patch", "exec_command", "write_stdin", "show_changes"],
    },
  ];
